...
try
    ...
    % CTER valence
    cter_v_nii = load_untouch_nii([proj.path.haufe.cter,'mu_haufe_v_N=',num2str(Nperm),'.nii']);
    ...
    % CTER arousal
    cter_a_nii = load_untouch_nii([proj.path.haufe.cter,'mu_haufe_a_N=',num2str(Nperm),'.nii']);
    ...
    hr_nii = load_untouch_nii([proj.path.haufe.hr,'mu_haufe_v_N=',num2str(Nperm),'.nii']);
    ...
    inca_nii = load_untouch_nii([proj.path.haufe.inca,'mu_haufe_a_N=',num2str(Nperm),'.nii']);
    ...
    export_fig 'CTER_HR_encoding_v_all_cmp.png' -r300  
    eval(['! mv ',proj.path.code,'CTER_HR_encoding_v_all_cmp.png ',proj.path.fig]);
    ...
    export_fig 'CTER_INCA_encoding_a_all_cmp.png' -r300  
    eval(['! mv ',proj.path.code,'CTER_INCA_encoding_a_all_cmp.png ',proj.path.fig]);
